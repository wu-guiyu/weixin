...
<body style="background: #F5F5F5;">
	...
	<div class="btn_right_now" onclick="bookVerifyCar('${oppind}');">立即预约</div>
	<div style="text-align:center;display:none;"><a href="http://www.beian.miit.gov.cn/" style="color:#ccc;font-size:14px;text-decoration: none;">黔ICP备18011911号</a></div>
