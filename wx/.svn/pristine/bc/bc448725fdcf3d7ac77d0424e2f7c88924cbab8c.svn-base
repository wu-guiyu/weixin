		...
		<aside class="main-sidebar" style="overflow: auto;">
			...
			<section class="sidebar" id="sidebar">
				...
				<ul class="sidebar-menu" id="sidebar-menu">
					...
					<li class="treeview" id="coupon"><a url="#" name="代金券管理"
														 nav="代金券管理" class="menu-link"> <i class="fa fa-list-alt"></i> <span>代金券管理</span>
						<span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li><a url="pages/coupon/coupon.jsp" name="代金券"
								   nav="代金券管理,优惠" class="menu-link"> <i class="fa fa-circle-o"></i>
								<span>代金券</span>
							</a></li>
							<li><a url="pages/coupon/lssueCoupon.jsp" name="发放代金券"
								   nav="代金券管理,发放代金券" class="menu-link"> <i class="fa fa-circle-o"></i>
								<span>发放代金券</span>
							</a></li>
						</ul></li>
					...
					<li class="treeview" id="wxHaibao"><a url="#" name="海报管理"
						nav="海报" class="menu-link"> <i class="fa fa-envelope"></i>
							<span>海报管理</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li><a url="pages/wxHaibao/YJcode.jsp" name="菜单"
								nav="海报管理,永久二维码" class="menu-link"> <i
									class="fa fa-circle-o"></i> <span>永久二维码</span>
							</a></li>
							<li><a url="pages/wxHaibao/Hbptsh.jsp" name="菜单"
								nav="海报管理,海报图片" class="menu-link"> <i
									class="fa fa-circle-o"></i> <span>海报图片</span>
							</a></li>
						</ul></li>
